let copyQuotes = [
  ...
  [56, "vi.6)The best way of revenge is not to imitate the injury.", false],
  [
    57,
  ...
  [
    71,
    "vii.15)Let people's tongues and actions be what they will, my business is to be good. And make the same speech to myself, that a piece of gold, or an emerald, or purple should. Let people talk and act as they please; I must be an emerald, and I must keep my colour.",
    false,
  ],
  [
    72,
    "vii.18)Is anyone afraid of change? I would gladly know what can be done without it? and what is dearer and more suitable to the universal nature? Pray, must not your wood be transformed before your bath can be ready for you? Must not your meat be changed to make it fit to nourish you? Indeed, what part of life or convenience can go forward without alteration? Now, in all likelihood a change in your condition may be as serviceable to the world in general, as those alterations above mentioned are to you.",
    false,
  ],
  [
    73,
    "vii.21)It will not be long before you will have forgotten all the world, and in a little time all the world will forget you too.",
    false,
  ],
  [
    74,
    "vii.25)That being which governs nature will quickly change the present face of it. One thing will be made out of another by frequent revolutions. And thus the world will be always new.",
    false,
  ],
  [
    75,
    "vii.29)Rub out the colours of imagination. Do not suffer your passions to make a puppet of you. Confine your care to the present. Look through that which happens either to yourself or another. Distinguish the parts of your subject, and divide them into the causal and material element. Think upon your last hour, and do not trouble yourself about other people's faults, but leave them with those that must answer for them.",
    false,
  ],
  [76, "vii.36)It is a royal thing to be ill spoken of for good deeds.", false],
  [
    77,
    "vii.49)By looking back into history, and considering the fate and revolutions of government, you will be able to draw a guess, and almost prophesy upon the future; for they will certainly be of the same nature, and cannot but be cast in the same mould. So that forty years of human life may serve for a sample of ten thousand. For what more will you see?",
    false,
  ],
  [
    78,
    "vii.58)When any accident happens, call to mind those who have formerly been under the same circumstances, how full of surprise, complaint, and trouble they were about the matter. And where are they now? They are gone, their murmuring could not make them immortal. To what purpose should you imitate their behaviour? Cannot you leave these foreign emotions to those who cause them, and those who are moved by them?",
    false,
  ],
  [
    79,
    "vii.65)Do not return the temper of ill-natured people upon themselves, nor treat them as they do the rest of mankind.",
    false,
  ],
  [
    80,
    "vii.69)He that is come to the top of wisdom and practice, spends every day as if it were his last, and is never guilty of over-excitement, sluggishness, or insincerity.",
    false,
  ],
  [
    81,
    "vii.72)Whatever business tends neither to the improvement of your reason, nor the benefit of society, the rational and social faculty thinks beneath it.",
    false,
  ],
  [
    82,
    "vii.73)When you have done a kindness, and your neighbor is the better for it, why need you be so foolish as to look any farther, and gape for reputation and requital?",
    false,
  ],
  [
    83,
    "viii.15)Would it not be an odd instance of surprise to stare at a fig-tree for bearing figs? Why then should it seem strange to us for the world to act like itself, and produce things pursuant to quality and kind? This is just as foolish as it would be for a physician to wonder at a fever, or a master of a vessel at a cross blast of wind.",
    false,
  ],
  [
    84,
    "viii.16)To retract or mend a fault at the admonition of a friend in no way hurts your liberty, for it is still your own activity which by means of your own impulse and judgment, and by your own mind, makes you see your mistake.",
    false,
  ],
  [
    85,
    "viii.27)Every man has three relations to acquit himself in: his body that encompasses him makes one, the Divine cause that gives to all men all things another, and his neighbours a third.",
    false,
  ],
  [
    86,
    "viii.33)As to the case of good fortune, take it without pride, and resign it without reluctance.",
    false,
  ],
  [
    87,
    "viii.36)Do not take your whole life into your head at a time, nor burden yourself with the weight of the future, nor form an image of all probable misfortunes. This method will but confound you.",
    false,
  ],
  [
    88,
    "viii.36)Besides, you are to remember, that neither what is past nor what is to come need afflict you, for you have only to deal with the present. Now, this is strangely lessened, if you take it singly and by itself.",
    false,
  ],
  [
    89,
    "viii.44)Make the best of your time while you have it. Those who are so solicitous about fame never consider that future generations will be much the same as the present whom they are vexed with, and they, too, are mortal, what then can the noise or opinions of such little mortals signify to you?",
    false,
  ],
  [
    90,
    "viii.46)No accident can happen to any man but what is consequent to his nature. And the same thing maybe affirmed of a beast, a vine, or a stone. Now if things fare no otherwise than according to kind and constitution, why should you complain? --You may be assured the universal nature has never laid upon you an intolerable evil.",
    false,
  ],
  [
    91,
    "viii.47)If anything external vexes you, take notice that it is not the thing which disturbs you, but your notion about it, which notion you may dismiss at once if you please.",
    false,
  ],
  [
    92,
    "viii.48)The mind is invincible when she turns to herself, and relies upon her own courage; in this case there is no forcing her will, though she has nothing but obstinacy for her defence.",
    false,
  ],
  [
    93,
    "viii.60)Understanding does not always drive onward like an arrow. The mind sometimes by making a halt, and going round for advice, moves straight on none the less, and hits the mark.",
    false,
  ],
  [
    94,
    "ix.31)Keep a calm spirit towards things that proceed from an external cause, and a just spirit towards those that proceed from a cause within you; that is, let your impulse and action aim at the interest of mankind, for then you know your faculties are in the right posture that nature has set them.",
    false,
  ],
  [
    95,
    "x.3)Whatever happens, either you have strength to bear it, or you have not. If you have, exert your nature, and never murmur at the matter. But if the weight is too heavy for you, do not complain; it will crush you, and then destroy itself.",
    false,
  ],
  [
    96,
    "x.12)Why need you be anxious about the event when you may examine the enterprise, and debate the reasonableness of it? If you find it practicable, go on contented, and let nothing divert you. But if you cannot see your way, make a halt, and take the best advice upon the case.",
    false,
  ],
  [
    97,
    "x.16)Spend no more time in stating the qualifications of a man of virtue, but endeavour to get them.",
    false,
  ],
  [
    98,
    "xi.1)The properties of a rational soul are these. She has the privilege to look into her own nature, to cut out her qualities and form herself to what character she pleases. Her business is never spoilt by interruption, as it happens in a dance or a play.",
    false,
  ],
  [
    99,
    "xi.9)People's malice or impertinence cannot beat you off your reason, or stop your progress in virtue. Be not then disconcerted, nor check your good nature towards them. If you meet with opposition and ill-will, you must neither be diverted nor disturbed, but keep your right judgment and action and your temper too towards people who try to hinder you or otherwise annoy you. For as it is a weakness to give in from fear and be diverted from your conduct, so it is likewise to be angry with impertinent people.",
    false,
  ],
  [
    100,
    "xi.12)The figure of the soul is then round and uniform, when she neither reaches after anything foreign, nor shrinks into herself, nor is dispersed or sunk in, but shines in the light by which she surveys the truth of all things and of herself too.",
    false,
  ],
  [
    101,
    "xi.14)People generally despise where they Hatter, and cringe to those they would gladly overtop.",
    false,
  ],
  [
    102,
    "xi.15)How fulsome and hollow does that man look that cries, `I'm resolved to deal straightforwardly with you.` Hark you, friend, what need of all this flourish? Let your actions speak; your face ought to vouch for your speech. I would have virtue look out of the eye, no less apparently than love does in the sight of the beloved. I would have honesty and sincerity so incorporated with the constitution, that it should be discoverable by the senses, and as easily distinguished as a strong breath, so that a man must be forced to find it out whether he would or no.",
    false,
  ],
  [
    103,
    "xi.15)Nothing is more scandalous than false friendship, and, therefore, of all things avoid it. In short, a man of integrity, sincerity, and good-nature can never be concealed, for his character is wrought into his countenance.",
    false,
  ],
  [
    104,
    "xi.18)Do not forget you are like the rest of the world, and faulty yourself in a great many instances: that though you may forbear from some errors, it is not for want of inclination, and that nothing but cowardice, vanity, or some such base principle hinders you from sinning.",
    false,
  ],
  [
    105,
    "xi.18)It is sometimes a hard matter to be certain whether men do wrong, for their actions often are done with a reference to circumstances; and one must be thoroughly informed of a great many things before he can be rightly qualified to give judgment in the case.",
    false,
  ],
  [
    106,
    "xi.29)People do not pretend to teach others to write and read till they have been taught themselves; this rule holds much more of life.",
    false,
  ],
  [
    107,
    "xi.33)He is a madman that expects figs on the trees in winter; and he is little better that calls for his children again when they are dead and buried.",
    false,
  ],
  [
    108,
    "xi.35)Grapes are first sour, then ripe, then raisins, these are all no more than bare alterations; not into nothing, but into something which does not appear at present.",
    false,
  ],
  [
    109,
    "xii.1)All those things you drudge, and range so much ground for, you may have at your ease, unless you are afraid of making yourself too happy. Your method to do your business is not to concern yourself about the time past, for that is never to be recovered; to rest the future with Providence, and only stick to the present, and improve that to all the noble purposes of piety and justice.",
    false,
  ],
  [
    110,
    "xii.4)I have often wondered how it comes to pass that everybody should love themselves best, and yet value their neighbour's opinion about themselves more than their own.",
    false,
  ],
  [
    111,
    "xii.8)Let it be your method to contemplate spirits apart from the shell they are shut up in, mind the aim of people's actions, examine the value of fame, the force of pain and pleasure, and see what death amounts to, and what reputation, consider upon what account a man grows troublesome to himself, that nobody can be hindered by another, and that everything is opinion.",
    false,
  ],
  [
    112,
    "xii.10)Be not satisfied with a superficial view of things, but penetrate into their matter and form, and the end they were made for.",
    false,
  ],
  [
    113,
    "xii.15)A lamp till it is extinguished holds its light, and shines without interruption, and can you find in your heart to see your truth, honesty, and sobriety extinguished before you?",
    false,
  ],
  [
    114,
    "xii.19)Consider, for it is high time, that you have something more divine in you than the mechanism of passion, than the wires of a puppet. What is there now in my soul? Is it fear, or suspicion, or desire? Or anything of this coarse nature?",
    false,
  ],
  [
    115,
    "xii.20)Take care never to do anything without thought, and design, nor for any other end but what may be serviceable to the interest of society.",
    false,
  ],
  [
    116,
    "xii.22)Remember that all things are opinion, and that it is in your own power to think as you please. Therefore remove the opinion, and then as if you had doubled some dangerous cape, you will have nothing but a steady course, a smooth sea, and a waveless bay to receive you.",
    false,
  ],
  [
    117,
    "xii.32)What a small part of immeasurable and infinite time falls to the share of a single mortal, and how soon is every one swallowed up in eternity. What a handful of the universal matter goes to the making of a human body, and what a very little of the universal soul too!",
    false,
  ],
  [
    118,
    "xii.33)The great business of a man is to improve his mind, therefore consider how he does this. As for all other things, whether in our power to compass or not, they are no better than lifeless ashes and smoke.",
    false,
  ],
];
...
function changeBookmarkColor() {
  const bookmarkButtonText = document.querySelector(
    "#bookmarkButton #bookmarkText"
  );
  ...
  bookmarkButton.addEventListener("click", async function () {
    try {
      if (!UserLoggedIn) {
        ...
        console.log(
          "bookmark inside the cannot bookmark if case   = " + bookmarkMaybe
        );
